...
public class RayCaster {
    ...
    public Vector2 findIntersection(Vector2 start, Vector2 goal, boolean lookForObstacles) {
        ...
        while (!tileFound && distance < MAX_DISTANCE && loop) {
            ...
            if (checkX >= 0 && checkX < MAP_WIDTH && checkY >= 0 && checkY < MAP_HEIGHT) {
                ...
                if (obstacleManager.tileIsObstacle(checkX, checkY, MAP_WIDTH) == lookForObstacles) {
                    tileFound = true;
                }
            }
